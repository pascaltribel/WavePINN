...
def run_fd_reference(c0: float = 1.0, t_max: float = 5.0, n_t: int = 250, L: float = 50.0, nx:int = 100, t0=1, cx=0, cy=0):
    dx = L*2/nx
    dt = t_max / n_t
    nx = int(2 * L / dx) + 1
...
check_wave_field(model, t_max=6, n_t=250, cx=0.0, snapshot_every=5)
